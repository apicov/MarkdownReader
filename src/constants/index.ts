...
/** Time to wait after pinch gesture before allowing drag (ms) */
export const PINCH_TO_DRAG_GRACE_PERIOD_MS = 300;
...
/** Delay before restoring scroll position after WebView loads (ms) */
export const SCROLL_RESTORE_DELAY_MS = 800;
...
/** Delay between file system operations when building file map (ms) */
export const FILE_PROCESSING_YIELD_INTERVAL = 10;

// ============================================================================
// UI & LAYOUT
// ============================================================================

/** Header padding top for status bar (px) */
export const HEADER_PADDING_TOP = 48;
...
/** AsyncStorage key for reading positions */
...
/** AsyncStorage key for documents cache */
...
/** Position in new content after TOC navigation jump (fraction of doc height) */
export const TOC_JUMP_SCROLL_POSITION = {
  /** For backward jump: show previous content with some context */
  backward: 0.28,
  /** For forward jump: show target content in comfortable reading position */
  forward: 0.52,
};
